 ...
 * @since v0.0.1
 */
public class VideoDownLoadAdapter1 extends BaseAdapter {
	...
	public VideoDownLoadAdapter1(Activity activity, Handler handler, List<LocalDownInfo> list) {
	...
	private void notifyData(){
		for(int i=0;i<list.size();i++){//编历数据源，为了与本地数据同步 。这个是不明智的作为。因为。每刷新 一次都 会操作文件 。效率性能很差
			// 重新检索本地库的数据
